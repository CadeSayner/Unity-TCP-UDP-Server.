...
public class Client
{
    ...
    public void SendIntoGame(string _playerName)
    {
        ...
        foreach (Client _client in Server.clients.Values)
        {
            if (_client.player != null)
            {
                // Given the exact same id as the client instance therefore the client number on the client 
                // will match with the particular instance of the player when the packet is sent
    ...
    private void Disconnect()
    {
        ...
        ThreadManager.ExecuteOnMainThread(() =>
        {   
            // Destroy only on the main thread
